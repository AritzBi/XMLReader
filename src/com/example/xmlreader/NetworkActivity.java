...
import com.example.xmlreader.TvDbXmlParser.Serie;
...
public class NetworkActivity extends Activity {
    ...
    private static final String URL =
            "http://www.thetvdb.com/api/GetSeries.php?seriesname=Fringe";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("Paso por la priema");
    ...
    private void loadPage() {
        if (((sPref.equals(ANY)) && (wifiConnected || mobileConnected))
            ...
            // AsyncTask subclass
        	System.out.println("Paso por load page");
    ...
    private class DownloadXmlTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            try {
            	System.out.println("paso por doinbackground");
    ...
    private String loadXmlFromNetwork(String urlString) throws XmlPullParserException, IOException {
    	System.out.println("Paso por loadXml...");
        InputStream stream = null;
        TvDbXmlParser stackOverflowXmlParser = new TvDbXmlParser();
        List<Serie> entries = null;
        String title = null;
        String url = null;
        String summary = null;
        ...
        // a text summary.
        for (Serie entry : entries) {
            htmlString.append("<p>" + entry.title + "</a></p>");
            // If the user set the preference to include summary text,
            // adds it to the display.
            if (pref) {
                htmlString.append(entry.overview);
            }
        }
    ...
    public class NetworkReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
        	System.out.println("Syso onReceive");
            ConnectivityManager connMgr =
